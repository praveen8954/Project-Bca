...
/BCA Project BUYZEE/BCA Project BUYZEE<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
  ...
  <div class="dairy">
    <span id="card">
      ...
      <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
          <img src="/BCA Project BUYZEE/Images/Ice Creams/1.jpg" class="card-img-top" alt="amul butter">
          <div class="card-body">
            <p class="card-text">Oreo Cornito</p>
  
                <section> <span class="rupees">30rs</span>
                 <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Oreo Cornito">
            <input type="hidden" name="Price" value="30">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Ice Creams/1.jpg">
          </div> 
      </div></form>
            <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
              <img src="/BCA Project BUYZEE/Images/Ice Creams/8.jpg" class="card-img-top" alt="Amul Milk 500ml">
              <div class="card-body">
                <p class="card-text">ADL Choclate</p>
                   <section><span class="rupees">150rs</span>
                 <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="ADL Choclate">
            <input type="hidden" name="Price" value="150">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Ice Creams/8.jpg">
              </div>
          </div></form>
            <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
              <img src="/BCA Project BUYZEE/Images/Ice Creams/2.jpg" class="card-img-top" alt="Amul Gold 1l">
              <div class="card-body">
                <p class="card-text">Amul King Alphonso Gold</p>
                  <section><span class="rupees">120rs</span>
                 <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Amul King Alphonso Gold">
            <input type="hidden" name="Price" value="120">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Ice Creams/2.jpg">
              </div>
          </div></form>
  
            <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
              <img src="/BCA Project BUYZEE/Images/Ice Creams/3.jpg" class="card-img-top" alt="Amul Lactose FREE 1L">
              <div class="card-body">
                <p class="card-text">Vadilal Flingo</p>
                   <section><span class="rupees">30rs</span>
                 <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Vadilal Flingo">
            <input type="hidden" name="Price" value="30">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Ice Creams/3.jpg">
          </div>
        </div></form>
      ...
      <span id="card">
         ...
         <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            <img src="/BCA Project BUYZEE/Images/Ice Creams/4.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <p class="card-text">Amul Vanilla Gold</p>
    
                  <section> <span class="rupees">130rs</span>
                   <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Amul Vanilla Gold">
            <input type="hidden" name="Price" value="130">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Ice Creams/4.jpg">
            </div> 
        </div></form>
              <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            ...
            <input type="hidden" name="Price" value="120">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Ice Creams/5.jpg">
                </div>
            </div></form>
            <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
                <img src="/BCA Project BUYZEE/Images/Ice Creams/6.jpg" class="card-img-top" alt="">
                <div class="card-body">
                  <p class="card-text">Vadilal Gourmat </p>
                     <section><span class="rupees">160rs</span>
                   <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Vadilal Gourmat">
            <input type="hidden" name="Price" value="160">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Ice Creams/6.jpg">
                </div>
            </div></form>
            <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
                <img src="/BCA Project BUYZEE/Images/Ice Creams/7.jpg" class="card-img-top" alt="Amul Milk 500ml">
                <div class="card-body">
                  <p class="card-text">Vadilal Gourmat</p>
                     <section><span class="rupees">170rs</span>
                   <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Vadilal Gourmat">
            <input type="hidden" name="Price" value="170">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Ice Creams/7.jpg">
                </div>
            </div></form>
      </span>
