  ...
  <div class="container">
    <div class="row">
      ...
      <table class='table text-center table-dark'>
                ...
                <tbody>
                    <?php
                $order_query="SELECT * FROM `user_orders` WHERE `username`='$_SESSION[user]'";
                $order_result=mysqli_query($conc,$order_query);
                while($order_fetch=mysqli_fetch_assoc($order_result))
                {
                echo" <tr>
                <td ><img src='$order_fetch[img_url]' alt='image' width='70px' height='50px'></td>
                <td>$order_fetch[item_name]</td>
                <td>$order_fetch[price]</td>
                <td>$order_fetch[quantity]</td>
                <td>$order_fetch[order_date]</td>
                </tr>";
                }
                ?>
                </tbody>
