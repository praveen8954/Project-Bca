...
<head>
    ...
    <title>BuyEzee</title>
    <link rel="stylesheet" href="/BCA Project BUYZEE/Code/Css/soaps.css">
</head>
<body>
<div id="header">
  ...
  <span id="card">
    ...
    <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
        <img src="/BCA Project BUYZEE/Images/Bathing Soaps_/1.jpg" class="card-img-top" alt="Patanjali Neem Kanti">
        <div class="card-body">
          ...
          <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            <img src="/BCA Project BUYZEE/Images/Bathing Soaps_/2.jpg" class="card-img-top" alt="Cinthol original">
            <div class="card-body">
              <p class="card-text">Cinthol original</p>
                 <section><span class="rupees">25rs</span>
               <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Cinthol original">
            <input type="hidden" name="Price" value="25">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Bathing Soaps_/2.jpg">
            </div>
        </div></form>
          <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            <img src="/BCA Project BUYZEE/Images/Bathing Soaps_/3.jpg" class="card-img-top" alt="Dettol icy cool">
            <div class="card-body">
          ...
          <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            <img src="/BCA Project BUYZEE/Images/Bathing Soaps_/4.jpg" class="card-img-top" alt="Dettol Skincare">
            <div class="card-body">
  ...
  <span id="card">
    ...
    <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
        <img src="/BCA Project BUYZEE/Images/Bathing Soaps_/5.jpg" class="card-img-top" alt="Dettol Original">
        <div class="card-body">
          <p class="card-text">Dettol Original</p>
             <section><span class="rupees">35rs</span>
               <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Dettol Original">
            <input type="hidden" name="Price" value="35">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Bathing Soaps_/5.jpg">
        </div> 
    </div></form>
          <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            <img src="/BCA Project BUYZEE/Images/Bathing Soaps_/6.jpg" class="card-img-top" alt="Pears">
            <div class="card-body">
              <p class="card-text">Pears</p>
                 <section><span class="rupees">24rs</span>
                 <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Pears">
            <input type="hidden" name="Price" value="24">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Bathing Soaps_/6.jpg">
            </div>
        </div></form>
          <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            <img src="/BCA Project BUYZEE/Images/Bathing Soaps_/7.jpg" class="card-img-top" alt="Himalaya Soap">
            <div class="card-body">
              <p class="card-text">Himalaya Cucumber</p>
                 <section><span class="rupees">140rs</span>
               <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Himalaya Cucumber">
            <input type="hidden" name="Price" value="140">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Bathing Soaps_/7.jpg">
            </div>
        </div></form>

          <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            <img src="/BCA Project BUYZEE/Images/Bathing Soaps_/8.jpg" class="card-img-top" alt=">Patanjali Alovera">
            <div class="card-body">
              <p class="card-text">Patanjali Alovera</p>
                 <section><span class="rupees">40rs</span>
               <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Patanjali Alovera">
            <input type="hidden" name="Price" value="40">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Bathing Soaps_/8.jpg">
        </div>
      </div>
      </form>
    </span>
  <span id="card">
    ...
    <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
        <img src="/BCA Project BUYZEE/Images/Bathing Soaps_/9.jpg" class="card-img-top" alt=">Patanjali HaldiKanti">
        <div class="card-body">
          <p class="card-text">Patanjali HaldiKanti</p>
             <section><span class="rupees">40rs</span>
               <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Patanjali HaldiKanti">
            <input type="hidden" name="Price" value="40">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Bathing Soaps_/9.jpg">
        </div> 
    </div></form>
          <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            <img src="/BCA Project BUYZEE/Images/Bathing Soaps_/10.jpg" class="card-img-top" alt="Himalaya Neem">
            <div class="card-body">
              <p class="card-text">Himalaya Neem</p>
              <section> <span class="rupees">40rs</span>
               <button class="add" type="submit" name="add">add</button></section>
            <input type="hidden" name="Item_Name" value="Himalaya Neem">
            <input type="hidden" name="Price" value="40">
            <input type="hidden" name="Item_Image" value="/BCA Project BUYZEE/Images/Bathing Soaps_/10.jpg">
            </div>
        </div></form>
          <!-- <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            <img src="/Images/DAIRY _ BREAKFAST _/Poha , Daliya _ Other Grains/1.jpg" class="card-img-top" alt="Rajdhani Poha">
            <div class="card-body">
          ...
          <!-- <form action="/BCA Project BUYZEE/Code/Html/manage_cart.php" method="post">   <div class="card" style="width: 11.5rem;">
            <img src="/Images/DAIRY _ BREAKFAST _/Poha , Daliya _ Other Grains/2.jpg" class="card-img-top" alt="Mother's choice sabudana">
            <div class="card-body">
